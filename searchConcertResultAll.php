		   ...
		   while ($row = $query->fetch(PDO::FETCH_ASSOC))
            ...
            <nav>
              <ul class="pagination">
                ...
                {
                    $previousPage = $page - 1;
                    echo "<li><a href='./searchConcertResultAll.php?page=$previousPage&sel_criteria=$sel_criteria'>Prev</a></li>";
                }
                ...
                for ($i=1; $i < $numPages+1; $i++)
                {
                    ...
                    if($i == $page)
                        $theClass = 'active';
                    echo "<li class='$theClass'><a href='./searchConcertResultAll.php?page=$i&sel_criteria=$sel_criteria'>$i</a></li>";
                }
                ...
                {
                    $nextPage = $page+1;
                    echo "<li><a href='./searchConcertResultAll.php?page=$nextPage&sel_criteria=$sel_criteria'>Next</a></li>";
                }
